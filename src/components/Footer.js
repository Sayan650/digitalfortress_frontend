...
export default () => {
    return <div className="bg-transparent">
        <div style={{display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center"}}>
            <div style={{color:"#fff", margin:"6px auto", textAlign:"center", maxWidth:"65%"}}><h5 className="foottxt">Created by GLUG</h5></div>
            ...
            &nbsp;
            <a href="https://www.instagram.com/arhn.nitd/"><InstagramIcon style={{fontSize: "30px", color:"#fff"}} /></a> */}
            </div>
