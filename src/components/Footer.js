  ...
  return (
    <div className="bg-transparent">
      ...
      >
        ...
        >
          <h5 className="foottxt">Created by GNU/Linux Users' Group</h5>
        </div>
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          &nbsp;
          <a href="https://github.com/lugnitdgp/">
          ...
          <a href="https://www.linkedin.com/company/lugnitdgp">
            <LinkedInIcon style={{ fontSize: "30px", color: "#fff" }} />
          </a>
          &nbsp;
          <a href="https://www.instagram.com/nitdgplug/">
